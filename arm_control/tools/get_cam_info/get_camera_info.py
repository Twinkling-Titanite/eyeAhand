...
camera_color_calib_img_path = package_path + '/tools/get_cam_info/img/camera_' + eyehand + '/'
camera_color_calib_result_path = package_path + '/tools/get_cam_info/result/camera_' + eyehand + '/'
