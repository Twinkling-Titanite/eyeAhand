...
camera_in_ir_info_topic = '/camera_in/infra1/camera_info'

# 相机矫正前图片话题
camera_in_depth_img_raw_topic = '/camera_in/depth/image_raw'
camera_in_ir_img_raw_topic = '/camera_in/infra1/image_raw'

# 相机矫正后图片话题
camera_in_depth_img_corrected_topic = '/camera_in/depth/image_corrected'
camera_in_ir_img_corrected_topic = '/camera_in/infra1/image_corrected'
