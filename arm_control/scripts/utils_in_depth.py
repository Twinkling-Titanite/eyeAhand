...
camera_in_ir_info_path = '/config/camera_in/depth/camera_ir_info.yaml'

# 录制图像路径
camera_in_ir_img_path = '/img/camera_in/depth/'

# 结果保存路径
camera_in_ir_result_path = '/result/camera_in/depth/'

# 相机位姿变换矩阵路径
cam2end_ir_tf_path = '/config/camera_in/depth/cam2world_tf_matrix.yaml'
