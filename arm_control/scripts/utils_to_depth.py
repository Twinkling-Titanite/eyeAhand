...
camera_to_ir_info_path = '/config/camera_to/depth/camera_ir_info.yaml'

# 录制图像路径
camera_to_ir_img_path = '/img/camera_to/depth/'

# 结果保存路径
camera_to_ir_result_path = '/result/camera_to/depth/'

# 相机位姿变换矩阵路径
cam2world_ir_tf_path = '/config/camera_to/depth/cam2world_tf_matrix.yaml'
