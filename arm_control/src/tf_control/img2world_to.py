...
def img2world_callback(position_1_msg, position_2_msg):
    ...
    # T_cam_color_to_cam_ir = np.dot(np.linalg.inv(T_cam_ir_to_world), T_cam_color_to_world)
...
def main():
    ...
    # 订阅红色物体的像素坐标
    position_sub_1 = message_filters.Subscriber('arm_control/red_position_1', PointStamped)
    position_sub_2 = message_filters.Subscriber('arm_control/red_position_2', PointStamped)
    rospy.wait_for_message('arm_control/red_position_1', PointStamped, timeout=None)
    rospy.wait_for_message('arm_control/red_position_2', PointStamped, timeout=None)
