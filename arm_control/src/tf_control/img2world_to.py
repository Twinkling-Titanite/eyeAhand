...
with open(package_path + camera_to_depth_to_color_path, 'r') as f:
    T_cam_depth_to_color = np.array(yaml.safe_load(f)['d2c_matrix'])
T_cam_depth_to_world = np.dot(T_cam_depth_to_color, T_cam_color_to_world)
...
def get_pose_service_handler(req):
    ...
    depth_1, p_depth_x_1, p_depth_y_1 = get_depth(pixel_1_x, pixel_1_y, depth_img, camera_to_matrix_color, camera_to_matrix_depth, T_cam_color_to_world, T_cam_depth_to_world)
    depth_2, p_depth_x_2, p_depth_y_2 = get_depth(pixel_2_x, pixel_2_y, depth_img, camera_to_matrix_color, camera_to_matrix_depth, T_cam_color_to_world, T_cam_depth_to_world)
    ...
    world_coords_1 = get_world_coordinates(p_depth_x_1, p_depth_y_1, depth_1, camera_to_matrix_depth, T_cam_depth_to_world)
    world_coords_2 = get_world_coordinates(p_depth_x_2, p_depth_y_2, depth_2, camera_to_matrix_depth, T_cam_depth_to_world)
