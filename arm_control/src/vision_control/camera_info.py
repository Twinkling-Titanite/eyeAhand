...
def camera_in_ir_info_callback(camera_info):
    ...
    with open(package_path + camera_in_ir_info_path, 'w') as f:
...
def camera_to_ir_info_callback(camera_info):
    ...
    with open(package_path + camera_to_ir_info_path, 'w') as f:
...
def main():
    ...
    rospy.Subscriber(camera_to_d2c_topic, Extrinsics, camera_to_depth_to_color_callback)
    rospy.Subscriber(camera_in_d2c_topic, Extrinsics, camera_in_depth_to_color_callback)
